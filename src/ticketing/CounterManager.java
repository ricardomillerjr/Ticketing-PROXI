...
public class CounterManager{
    ...
    public static Counterr getNumber(String counter_Lane) throws SQLException, IOException, JRException {
        try {
           
            CallableStatement callableStatement = connection.prepareCall("{call counter_number(?)}", ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
        ...
        } catch (JRFillInterruptedException ex) {
